        ...
        public class GivenNoContext
        {
            ...
            public void WhenUpdateVersionWithZeroVersion_ThenThrows()
            {
                this.version
                    ...
                    .WithMessage(ExceptionMessages.ToolkitVersion_ZeroVersion.Substitute("0.0.0"));
            }
            ...
            public void WhenUpdateVersionWithLowerVersionThanCurrent_ThenThrows()
            {
                ...
                this.version
                    ...
                    .Should().Throw<AutomateException>()
                    .WithMessage(ExceptionMessages.ToolkitVersion_VersionBeforeCurrent.Substitute("0.1.0", "0.2.0"));
            }
            ...
            public void WhenUpdateVersionWithZeroDotNumber_ThenThrows()
            {
                this.version
                    ...
                    .Should().Throw<ArgumentOutOfRangeException>()
                    .WithMessage(ExceptionMessages.VersionInstruction_InvalidVersionInstruction.Substitute("2") + "*");
            }
            ...
            public void WhenUpdateVersionWithThreeDotNumber_ThenThrows()
            {
                this.version
                    ...
                    .Should().Throw<ArgumentOutOfRangeException>()
                    .WithMessage(ExceptionMessages.VersionInstruction_InvalidVersionInstruction.Substitute("1.1.1.1") +
                                 "*");
            }
        }
        ...
        public class GivenBreakingChange
        {
            ...
            public void WhenUpdateVersionWithSameVersionAsCurrent_ThenThrows()
            {
                this.version
                    ...
                    .Should().Throw<AutomateException>()
                    .WithMessage(
                        ExceptionMessages.ToolkitVersion_IllegalVersion.Substitute("0.1.0", "1.0.0",
                            "abreakingchange"));
            }
            ...
            public void WhenUpdateVersionWithGreaterMinorVersionThanCurrent_ThenThrows()
            {
                this.version
                    ...
                    .Should().Throw<AutomateException>()
                    .WithMessage(
                        ExceptionMessages.ToolkitVersion_IllegalVersion.Substitute("0.10.0", "1.0.0",
                            "abreakingchange"));
            }
