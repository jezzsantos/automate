...
namespace Automate.Authoring.Domain {
    ...
    internal class VersionChanges {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Pattern (ID: {PatternId}) has changed its runtime version from {Published} to {Installed}.
        /// </summary>
        internal static string Pattern_RuntimeVersion_Update {
            get {
                return ResourceManager.GetString("Pattern_RuntimeVersion_Update", resourceCulture);
            }
        }
