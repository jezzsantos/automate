...
namespace Automate.Domain
{
    ...
    internal class AutomationSchema : IAutomationSchema
    {
        ...
        public IAutomation GetExecutable(DraftDefinition draft, DraftItem draftItem)
        {
            return Automation.GetExecutable(draft, draftItem);
        }

        public bool IsLaunching()
        {
            return Automation.IsLaunching;
        }
    }
