...
namespace CLI.UnitTests.Domain
{
    ...
    public class CollectionAutoNamerSpec
    {
        ...
        {
            this.element.AddAutomation(new Automation("anautomationname", AutomationType.Unknown,
        ...
        {
            this.element.AddAutomation(new Automation("Unknown2", AutomationType.Unknown,
                new Dictionary<string, object>()));
