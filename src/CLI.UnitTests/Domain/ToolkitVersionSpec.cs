...
namespace CLI.UnitTests.Domain
{
    public class ToolkitVersionSpec
    {
        ...
        public class GivenNoContext
        {
            ...
            {
                this.version
                    .Invoking(x => x.UpdateVersion("0.0.0"))
            ...
            {
                this.version
                    .Invoking(x => x.UpdateVersion("invalidinstruction"))
                    .Should().Throw<ArgumentOutOfRangeException>()
                    .WithMessage(ExceptionMessages.ToolkitVersion_InvalidVersionInstruction.Format("invalidinstruction") + "*");
            }

            [Fact]
            public void WhenUpdateVersionWithLowerVersionThanCurrent_ThenThrows()
            {
                this.version.UpdateVersion("0.2.0");

                this.version
                    .Invoking(x => x.UpdateVersion("0.1.0"))
                    .Should().Throw<AutomateException>()
            ...
            {
                this.version
                    .Invoking(x => x.UpdateVersion("2"))
                    .Should().Throw<ArgumentOutOfRangeException>()
                    .WithMessage(ExceptionMessages.ToolkitVersion_InvalidVersionInstruction.Format("2") + "*");
            }

            [Fact]
            public void WhenUpdateVersionWithOneDotNumber_ThenReturnsVersion()
            {
                var result = this.version.UpdateVersion("1.1");
            ...
            {
                var result = this.version.UpdateVersion("1.1.1");
            ...
            {
                this.version
                    .Invoking(x => x.UpdateVersion("1.1.1.1"))
                    .Should().Throw<ArgumentOutOfRangeException>()
                    .WithMessage(ExceptionMessages.ToolkitVersion_InvalidVersionInstruction.Format("1.1.1.1") + "*");
            }
        }
        ...
        public class GivenNoChange
        {
            ...
            {
                var result = this.version.UpdateVersion(null);
            ...
            {
                var result = this.version.UpdateVersion(ToolkitVersion.AutoIncrementInstruction);
            ...
            {
                var result = this.version.UpdateVersion("0.1.0");
            ...
            {
                var result = this.version.UpdateVersion("0.10.0");
            ...
            {
                var result = this.version.UpdateVersion("10.0.0");
        ...
        public class GivenBreakingChange
        {
            ...
            {
                this.version
                    .Invoking(x => x.UpdateVersion("0.10.0"))
                    .Should().Throw<AutomateException>()
            ...
            public void WhenUpdateVersionWithGreaterMajorVersionThanCurrent_ThenReturnsNewVersion()
            {
                var result = this.version.UpdateVersion("2.0.0");
