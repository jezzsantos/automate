    ...
    public class AuthoringApplicationSpec
    {
        ...
        public void WhenAddCodeTemplateCommandAndCodeTemplateNotExistsOnDescendant_ThenThrows()
        {
            ...
            this.application
                ...
                .Should().Throw<AutomateException>()
                .WithMessage(
                    ExceptionMessages.AuthoringApplication_CodeTemplateNotExistsElement.Format("atemplatename",
                        "{apatternname.anelementname}"));
        }
        ...
        public void WhenTestCodeTemplateAndImportDataNotExist_ThenThrows()
        {
            ...
            this.application
                ...
                .Should().Throw<AutomateException>()
                .WithMessage(
                    ExceptionMessages.AuthoringApplication_TestDataImport_NotFoundAtLocation.Format("afullpath"));
        }
        ...
        public void WhenTestCodeTemplateAndExportDataAndNotFile_ThenThrows()
        {
            ...
            this.application
                ...
                .Should().Throw<AutomateException>()
                .WithMessage(
                    ExceptionMessages.AuthoringApplication_TestDataExport_NotValidFile.Format("afullpath",
                        "anerrormessage"));
        }
        ...
        public void WhenTestCodeTemplateCommandAndCodeTemplateNotExists_ThenThrows()
        {
            ...
            this.application
                ...
                .Should().Throw<AutomateException>()
                .WithMessage(
                    ExceptionMessages.AuthoringApplication_CodeTemplateCommandNotExistsRoot.Format("acommandname"));
        }
